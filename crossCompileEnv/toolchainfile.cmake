...
# DaQui Modified
SET(CROSSCOMPILE_ROOT_PATH /home/daqui/BRCrossCompile)
SET(CROSSCOMPILE_SYSROOT_PATH ${CROSSCOMPILE_ROOT_PATH}/aarch64-buildroot-linux-gnu/sysroot)
SET(CMAKE_PREFIX_PATH ${CROSSCOMPILE_SYSROOT_PATH}/opt/ros/kinetic ${CROSSCOMPILE_SYSROOT_PATH}/usr ${CROSSCOMPILE_ROOT_PATH}/opt/ros/kinetic ${CROSSCOMPILE_ROOT_PATH}/usr)
SET(PYTHON_EXECUTABLE ${CROSSCOMPILE_ROOT_PATH}/usr/bin/python)
SET(EMPY_SCRIPT ${CROSSCOMPILE_ROOT_PATH}/lib/python2.7/site-packages/em.pyc)
